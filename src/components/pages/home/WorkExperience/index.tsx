  ...
  const jobs = [
    {
      ...
      company: "Betablocks",
      icon: "img/components/Work/betablocks.png",
      start: "January, 2024",
      end: "Current",
      description: <>
        <p>
          Full Stack Developer in Miami based company working with Web3 technologies such as NFTs, crypto and blockchains.
          Our main projects mostly revolve around ESG initiatives and rewards programs using Web3 technologies, with clients such as
          as <a target="_blank" rel="noreferrer" href="https://www.bv.com.br/">Banco BV</a> and <a target="_blank" rel="noreferrer" href="https://www.pelxp.com/">PelXP</a>.
        </p>
        <p>
          I worked on several projects for different clients, with my main task being to maintain and add functionalities to
          our <a target="_blank" rel="noreferrer" href="https://builder.betablocks.com/login">page builder</a>, where I worked mostly as
          a front-end developer using React, UI/UX designer and back-end developer using Python&apos;s Django.
        </p>
      </>
    },
    {
